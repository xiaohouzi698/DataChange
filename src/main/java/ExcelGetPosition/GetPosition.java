...
public class GetPosition {
    static String AK = "C1p1XPqVBU2lMtCRPSpu8h2rAd8VbjtG"; // 百度地图密钥

    public static void main(String[] args) throws IOException,
            InvalidFormatException {
        String excelPath = "C:\\Users\\maxin\\Desktop\\sline_hotel2222.xlsx";
        ...
        try {
            ...
            if (excel.isFile() && excel.exists()) {   //判断文件是否存在
                ...
                String outPath = "C:\\Users\\maxin\\Desktop\\test222221.xlsx";
                Workbook wb2 = null;
                ...
                //for (int rIndex = firstRowIndex; rIndex <= 30; rIndex++) {   //遍历行
                for (int rIndex = firstRowIndex; rIndex <= lastRowIndex; rIndex++) {   //遍历行
                    ...
                    if (row != null) {
                      ...
                      //  Cell cell10 = row.getCell(37);  //sline_hotel专用
                      //  Cell cell11 = row.getCell(38);  //sline_hotel专用
                        Cell cell10 = row.getCell(0);
                        Cell cell11 = row.getCell(1);
                        if (cell10 != null) {
                            String c10 = cell10.toString();
                            String c11 = cell11.toString();
                            System.out.println("c10:"+c10+" c11:"+c11+"\n");
                            double lng = Double.parseDouble(c10);
                            double lat = Double.parseDouble(c11);
                            ...
                            if(null != Geocoder) {
                                ...
                                cellxx.setCellValue(Geocoder);
                                System.out.println("address: "+Geocoder);
                            }
                        }
